...
function twentyten_setup() {
	...
	register_nav_menus( array(
		'contextual' => __( 'Contextual Navigation', 'twentyten' ),
	) );
	register_nav_menus( array(
	...
	$custom_header_support = array(
		...
		'width' => apply_filters( 'twentyten_header_image_width', 1170 ),
...
// Carga jQuery y scripts personalizados
...
function my_scripts_method() {
    ...
    //Carga Scripts Bootstrap (Seleccionar sÃƒÂ³lo los necesarios y comentar el resto)
	wp_register_script('affix',
		get_template_directory_uri() . '/js/bootstrap-affix.js',
		array('jquery'),
		'1.0' );
	...
	wp_register_script('button',
		get_template_directory_uri() . '/js/bootstrap-button.js',
		array('jquery'),
		'1.0' );
	...
	wp_register_script('modal',
		get_template_directory_uri() . '/js/bootstrap-modal.js',
		array('jquery'),
		'1.0' );
	wp_enqueue_script('modal');
	wp_register_script('popover',
		get_template_directory_uri() . '/js/bootstrap-popover.js',
		array('jquery'),
		'1.0' );
	wp_enqueue_script('popover');
	wp_register_script('scrollspy',
		get_template_directory_uri() . '/js/bootstrap-scrollspy.js',
		array('jquery'),
		'1.0' );
	wp_enqueue_script('scrollspy');
	wp_register_script('tab',
		get_template_directory_uri() . '/js/bootstrap-tab.js',
		array('jquery'),
		'1.0' );
	wp_enqueue_script('tab');
	wp_register_script('tooltip',
		get_template_directory_uri() . '/js/bootstrap-tooltip.js',
		array('jquery'),
		'1.0' );
	...
	wp_register_script('typeahead',
		get_template_directory_uri() . '/js/bootstrap-typeahead.js',
		array('jquery'),
		'1.0' );
...
// Ajustar submenus a modo Bootstrap https://gist.github.com/1817371
